...
const LeetcodeIcon = ({ size = 16 }: { size?: number }) => (
  <svg 
    ...
    height={size} 
    fill="currentColor"
    className="lucide lucide-leetcode"
  >
    <path d="M13.483 0a1.39 1.39 0 0 0-.961.411l-9.66 9.713a1 1 0 0 0 0 1.415l4.885 4.9a1 1 0 0 0 1.415 0l9.66-9.713a1.39 1.39 0 0 0-.961-2.376h-4.38zm-6.22 12.02l4.885 4.9a1 1 0 0 0 1.415 0l4.385-4.41a1 1 0 0 0 0-1.415l-4.885-4.9a1 1 0 0 0-1.415 0l-4.385 4.41a1 1 0 0 0 0 1.415z" />
  </svg>
)
...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    role: 'SENIOR ADVISOR ',
    image: '/gallery/heads/utkarsh.jpeg',
    github: undefined,
    instagram: 'https://www.instagram.com/utkarsh__sriv_/',
    linkedin: 'https://www.linkedin.com/in/utkarsh-srivastava-80134a2a5?utm_source=share_via&utm_content=profile&utm_medium=member_android',
  },
  {
    name: 'ALOK SRIVASTAVA',
    role: 'SENIOR ADVISOR ',
    image: '/gallery/heads/alok.jpeg',
    github: undefined,
    instagram: 'https://www.instagram.com/alok_srivastava_04/',
    linkedin: 'https://www.linkedin.com/in/alok-srivastava-',
  },
    {
    name: 'SANIYA WALAVALKAR',
    role: 'SENIOR ADVISOR',
    image: '/gallery/heads/saniya.jpeg',
    github: undefined,
    instagram: 'https://www.instagram.com/saniya__abc/',
    linkedin: 'https://www.linkedin.com/in/walavalkar-saniya?utm_source=share_via&utm_content=profile&utm_medium=member_android',
  },  {
    name: 'ARYAN TRIPATHI ',
    role: 'PRESIDENT ',
    ...
    image: '/gallery/heads/palak.jpeg',
    github: undefined,
    instagram: 'https://www.instagram.com/palakbhatia_04/',
    linkedin: 'https://www.linkedin.com/in/palak-bhatia-116277355',
  },  {
    name: 'AYUSH SINGHAL ',
    role: 'CHIEF OF EXECUTION',
    image: '/gallery/heads/ayushcoe.jpg',
    github: 'https://github.com/Ayush1974-RGB',
    instagram: 'https://www.instagram.com/anotherayush_/',
    linkedin: 'https://www.linkedin.com/in/aayush-singhal-90011337a',
  },  {
    name: 'AYUSH BHARDWAJ',
    role: 'MANAGEMENT HEAD ',
    image: '/gallery/heads/AYUSH.jpg',
    github: undefined,
    instagram: 'https://www.instagram.com/ayush_0180/',
    linkedin: undefined,
  },  {
    name: 'SHIVAM SHARMA ',
    role: 'TECHNICAL HEAD (CSE)',
    image: '/gallery/heads/shivi.jpg',
    github: 'https://github.com/shivi5906',
    leetcode:'https://leetcode.com/u/shivi5906/' ,
    instagram: 'https://www.instagram.com/btwits_ss31/',
    linkedin: 'https://www.linkedin.com/in/shivam-sharma50931/',
  },  {
    name: 'SOUMYA SONEJA',
    role: 'TECHNICAL HEAD (CSE) ',
    image:'/gallery/heads/somya.jpeg',
    codechef: 'https://www.codechef.com/users/sonejasoumya',
    leetcode: 'https://leetcode.com/u/sonejasoumya/',
    instagram: 'https://www.instagram.com/sonejasoumya/',
    linkedin: 'https://www.linkedin.com/in/soumya-soneja/',
  },  {
    name: 'AVNI BANSAL',
    role: 'TECHNICAL HEAD (ECE) ',
    image: '/gallery/heads/avni.jpeg',
    github: undefined,
    instagram: 'https://www.instagram.com/avni_bansal143/',
    linkedin: 'https://www.linkedin.com/in/avnibansal1405',
  },  {
    ...
    image: '/gallery/heads/lavanya.jpeg',
    github: undefined,
    instagram: 'https://www.instagram.com/lavvanyyaaaa_?utm_source=qr',
    linkedin: 'https://in.linkedin.com/in/lavanyataneja3006',
  },  {
    name: 'AARUSHI SINGH',
    role: 'DIGITAL AND CINEMATICS HEAD',
    image: '/gallery/heads/arushi.JPEG',
    github: undefined,
    instagram: 'https://www.instagram.com/aarushiiisinghh/',
    linkedin: 'https://www.linkedin.com/in/aarushi-singh-18729034a?utm_source=share_via&utm_content=profile&utm_medium=member_ios',
  },  {
    name: 'DISHA MOHNANI',
    role: 'DIGITAL AND CINEMATICS HEAD ',
...
export default function TeamSection({ onBack, onHome }: TeamSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4">
        {member.github && (
          <a {...getLinkProps(member.github)} className="text-[#6b6b6b] hover:text-[#f5f5dc] transition-colors cursor-pointer" title="GitHub">
            <Github size={16} />
          </a>
        )}
        {member.codechef && (
          <a {...getLinkProps(member.codechef)} className="text-[#6b6b6b] hover:text-[#f5f5dc] transition-colors cursor-pointer" title="CodeChef">
            <CodechefIcon size={16} />
          </a>
        )}
        {member.leetcode && (
          <a {...getLinkProps(member.leetcode)} className="text-[#6b6b6b] hover:text-[#f5f5dc] transition-colors cursor-pointer" title="LeetCode">
            <LeetcodeIcon size={16} />
          </a>
        )}
        {member.instagram && (
          <a {...getLinkProps(member.instagram)} className="text-[#6b6b6b] hover:text-[#f5f5dc] transition-colors cursor-pointer" title="Instagram">
            <Instagram size={16} />
          </a>
        )}
        {member.linkedin && (
          <a {...getLinkProps(member.linkedin)} className="text-[#6b6b6b] hover:text-[#f5f5dc] transition-colors cursor-pointer" title="LinkedIn">
            <Linkedin size={16} />
          </a>
        )}
      </div>
